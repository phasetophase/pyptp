"""Tests for TSelectionMS behavior using the new registration system."""
...
class TestSelectionRegistration(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        node1 = NodeMV(
            NodeMV.General(guid=self.node1_guid, name="TestNode1"),
        ...
        node2 = NodeMV(
            NodeMV.General(guid=self.node2_guid, name="TestNode2"),
            [NodePresentation(sheet=self.sheet_guid)],
        )
    ...
    def test_selection_registration_works(self) -> None:
        ...
        general = SelectionMV.General(name="TestSelection")

        objects = [
            SelectionMV.Object(guid=self.node1_guid),
            SelectionMV.Object(guid=self.node2_guid),
        ]

        selection = SelectionMV(general, objects)
    ...
    def test_empty_selection_serializes_correctly(self) -> None:
        ...
        general = SelectionMV.General(name="EmptySelection")

        selection = SelectionMV(general, [])
        selection.register(self.network)
    ...
    def test_duplicate_selection_registration_allows_duplicates(self) -> None:
        ...
        general1 = SelectionMV.General(name="TestSelection")
        objects1 = [SelectionMV.Object(guid=self.node1_guid)]
        selection1 = SelectionMV(general1, objects1)
        selection1.register(self.network)

        general2 = SelectionMV.General(name="TestSelection")
        objects2 = [SelectionMV.Object(guid=self.node2_guid)]
        selection2 = SelectionMV(general2, objects2)
    ...
    def test_selection_deserialization_works(self) -> None:
        ...
        selection = SelectionMV.deserialize(data)
    ...
    def test_selection_round_trip_serialization(self) -> None:
        ...
        original_general = SelectionMV.General(name="RoundTripSelection")
        original_objects = [
            SelectionMV.Object(guid=self.node1_guid),
            SelectionMV.Object(guid=self.node2_guid),
        ]
        original_selection = SelectionMV(original_general, original_objects)
        ...
        # Deserialize
        deserialized_selection = SelectionMV.deserialize(data)
